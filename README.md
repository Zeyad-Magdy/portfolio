...
- [x] Attack Disruption Lab screenshots have been added to `attack-disruption-assets/` and placed in the case-study page with descriptive alt text.
- [ ] VM Deletion Lab still has `[ screenshot placeholder ]` boxes. Add the real build and end-to-end test screenshots only after the deletion test is complete.
